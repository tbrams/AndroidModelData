...
public class SampleTripDataProvider {
    ...
    public static List<WpItem>        sWpListForAllOperation;
    ...
    static {
        ...
        // ----- Prepare data for add all operation

        sWpListForAllOperation = new ArrayList<>();
        sWpListForAllOperation.add(new WpItem(null, "EKRK_1", 55.59,	12.13, null, "2000", null, "1"));
        sWpListForAllOperation.add(new WpItem(null, "EKRK_2", 56.59,	13.13, 11.5, "2000", null, "2"));
        sWpListForAllOperation.add(new WpItem(null, "EKRK_3", 57.59,	14.13, 22.6, "2000", null, "3"));
